...
class NetworkUtil {
  ...
  Future<List<PolylineResult>> getRouteBetweenCoordinatesOld({
    ...
    print("ChecKAPICALL::::");
    print("ChecKHeaders::::${request.headers}");
    print("ChecKAPICALL:::URL:${request.toUri(apiKey: googleApiKey)}");
    var response = await http.post(
      request.toUri(apiKey: googleApiKey),
      headers: {
        "X-Goog-Api-Key":googleApiKey.toString()
      },
    );
    print("ChecKAPICALL:::statusCode::${response.statusCode}");
    print("ChecKAPICALL:::RESPONSE::${response.body}");
